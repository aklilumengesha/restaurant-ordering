  ...
  const getErrorMessage = (err: string) => {
    switch (err) {
      case 'CredentialsSignin':
        return 'Invalid email or password. If you registered with Google, use "Continue with Google".'
      case 'OAuthAccountNotLinked':
      case 'AccountNotLinked':
        return 'This email is already registered with a different sign-in method. Please sign in using that method first.'
      case 'OAuthCreateAccount':
        return 'We could not create or link your Google account automatically. Please try again.'
      default:
      ...
      <div className="w-full max-w-md">
        <div className="card p-8 space-y-6">
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <span className="text-red-500 font-medium">Contact us to get started</span>
          </p>
        </div>
      </div>
    </div>
